        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Activos_Clientes_ClienteId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ClienteId = table.Column<int>(type: "int", nullable: false),
                    TarifaMensual = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    HorasIncluidas = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HistorialActivos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HistorialActivos_Activos_ActivoId",
                        column: x => x.ActivoId,
                        principalTable: "Activos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HistorialActivos_Tecnicos_TecnicoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HistorialActivos_ActivoId",
                table: "HistorialActivos",
                column: "ActivoId");

            migrationBuilder.CreateIndex(
                name: "IX_HistorialActivos_TecnicoId",
                table: "HistorialActivos",
                column: "TecnicoId");
